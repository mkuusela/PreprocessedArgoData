...
save(['./My_data/Argo_data_aggr_',num2str(month,'%02d'),'.mat'],'startYear','endYear','nProf','profLatAggr','profLongAggr','profYearAggr','profFloatIDAggr','profJulDayAggr','profPresAggr','profTempAggr','profPsalAggr');